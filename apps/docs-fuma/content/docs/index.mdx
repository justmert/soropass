...
<Callout type="info" title="Proven, not promised">
  ...
  transaction](https://stellar.expert/explorer/public/tx/6a532cc4b69d3361646cb7902c6e1040e0e0c84555fb2effb2f5297ad5b325e1)
...
<Cards>
  ...
  <Card icon={<Wallet />} title="Existing wallets" href="/docs/existing-wallets">
    Add passkeys to users who already hold a classic account: migration, backup devices, recovery.
  </Card>
  <Card icon={<Coins />} title="Fees and sponsorship" href="/docs/sponsorship">
