...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
  <figure style={{ margin: 0 }}>
    <img
      src="/screenshots/states-light.png"
      alt="All SoroPass UI states in the light skin"
      style={{ width: '100%', borderRadius: 8 }}
    />
    <figcaption>Light (default)</figcaption>
  </figure>
  <figure style={{ margin: 0 }}>
    <img
      src="/screenshots/states-dark.png"
      alt="All SoroPass UI states in the dark skin"
      style={{ width: '100%', borderRadius: 8 }}
    />
    <figcaption>Dark (`data-theme="dark"`)</figcaption>
  </figure>
</div>
