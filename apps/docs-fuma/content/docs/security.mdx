...
<Callout type="tip">
  ...
  and the [wrong-key
  rejection](https://stellar.expert/explorer/public/tx/6841ae73bfa37a7be2b6c309a8968c5eeb32534a05a9525a225ed69b4b3d795f).
  On testnet, the [success
  tx](https://stellar.expert/explorer/testnet/tx/fdeb2829089bf65fe650cc2b94f5a3fc6a329cca4f8bdf6812f5b803b35d20fa)
  and the [wrong-key
  rejection](https://stellar.expert/explorer/testnet/tx/d982dab7fc3a8c77011cf17e5507cd8a716963be80ab9b924c5f289dfa7c9ae5).
  Real hashes come from `packages/core/scripts/transfer-e2e.ts` and `transfer-e2e-mainnet.ts`, never
  fabricated.
</Callout>
