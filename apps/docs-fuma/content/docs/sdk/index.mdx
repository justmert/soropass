...
title: SDK reference
icon: Package
description: The @soropass/core create + sign primitives — ES256-only registration, public-key extraction, passkey-signed Soroban auth entries, and the frozen error taxonomy.
---
...
| `userName` _(required)_ | `string`                                     | Account name presented to the user during registration.                         |
...
<Callout type="tip">
  ...
  click handler so the registration ceremony is allowed to prompt.
</Callout>
