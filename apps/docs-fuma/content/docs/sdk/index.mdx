...
<Cards>
  <Card title="Create" href="/docs/sdk/create">
    createPasskey, AccountDeployer, COSE → SEC-1 key helpers
  </Card>
  <Card title="Sign" href="/docs/sdk/sign">
    signTransaction, signAuthEntry, browserPasskeySigner, low-S
  </Card>
  <Card title="Recover & Connect" href="/docs/sdk/recover">
    recover → RecoverResult[], connect → ConnectResult | null
  </Card>
  <Card title="Adapters" href="/docs/sdk/adapters">
    direct · launchtube · oz-relayer · events · mercury
  </Card>
  <Card title="KitError taxonomy" href="/docs/sdk/errors">
    10 frozen codes → cause → UI copy → recovery
  </Card>
</Cards>
...
<Callout type="info">
  One frozen 10-code taxonomy → one error layout, copy swapped by code. See [the full
  taxonomy](/docs/sdk/errors).
</Callout>
