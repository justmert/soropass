...
description: How the living compatibility matrix stays sourced and machine-verified.
---
...
flowchart TB
  ...
  subgraph T1["Tier 1 — automated · every release + weekly cron"]
    ...
    SITE["docs site<br/>dated · diffable · 'your device' panel"]
    BCD --> BUILD
    LIVE --> CI
    CI --> BUILD
    BUILD --> SITE
...
| docs site                  | S09 / S22 | `apps/matrix/site/**` (`pnpm --filter @stellar-passkey/matrix build`)     |
