...
exports.DcentModule = exports.DCENT_ID = void 0;
const mod_js_1 = require("../../types/mod.js");
const utils_js_1 = require("../utils.js");
exports.DCENT_ID = "dcent";
/**
...
class DcentModule {
    ...
    getProvider() {
        ...
        if (!provider) {
            throw (0, utils_js_1.parseError)({ code: -1, message: "D'CENT Stellar provider is not available" });
        }
        return provider;
    }
    async isAvailable() {
    ...
    async getAddress(params) {
        try {
            ...
            if (params?.skipRequestAccess !== true) {
                await provider.requestAccess().catch(() => undefined);
            }
            const { address, error } = await provider.getAddress();
            if (error)
                return Promise.reject((0, utils_js_1.parseError)(error));
            if (!address) {
...
exports.DcentModule = DcentModule;
